...
// Active Recall Pause Point. Inserted every PAUSE_INTERVAL paragraphs.
// Asks the reader to recall without looking back (retrieval practice,
// not note-taking) and saves the answer via onRecall.
export default function PausePoint({ pauseIdx, onRecall }) {
      ...
      {!saved ? (
        <div style={{ maxWidth: 480, margin: "0 auto", display: "flex", gap: 10, alignItems: "flex-start" }}>
          <textarea
            ...
            rows={2}
            aria-label="What do you remember from the last few paragraphs?"
