...
import { PALETTE, FONT_SERIF, FONT_SANS, FONT_SIZES } from "../data/constants.js";
import { ToggleSwitch, ChevronIcon } from "./Primitives.jsx";
  ...
  return (
    <>
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button
              ...
              style={{
                ...
                fontSize: 13,
                cursor: fontSizeIdx === 0 ? "not-allowed" : "pointer",
                opacity: fontSizeIdx === 0 ? 0.35 : 1,
              }}
            >
              A−
            </button>
            ...
            <button
              ...
              style={{
                ...
                fontFamily: FONT_SANS,
                fontSize: 13,
                cursor: fontSizeIdx === FONT_SIZES.length - 1 ? "not-allowed" : "pointer",
                opacity: fontSizeIdx === FONT_SIZES.length - 1 ? 0.35 : 1,
              }}
            >
              A+
            </button>
        ...
        >
          {deepFocus
            ? "Dimming nearby paragraphs to keep you in flow."
            : "Deep Focus dims surrounding paragraphs as you read."}
        </p>
      </div>
    </>
  );
