...
export default function WisdomLedgerPanel({ open, insights, onClose }) {
  ...
  const filtered = search.trim()
    ? insights.filter(
        (ins) =>
          ins.text.toLowerCase().includes(search.toLowerCase()) ||
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          borderLeft: `1px solid ${PALETTE.paperDeep}`,
      ...
      >
        ...
        >
          <div>
            ...
            {insights.length > 0 && (
              ...
              >
                {insights.length} insight{insights.length === 1 ? "" : "s"} this session
              </p>
            )}
          </div>
          <button
        ...
        {filtered.length === 0 && insights.length === 0 ? (
          ...
          >
            Turn on Socratic Margin and tap a paragraph. Write your own insight — it
            collects here.
          </p>
        ) : filtered.length === 0 ? (
