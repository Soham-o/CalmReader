...
import { loadArchive } from "../lib/archiveStorage";

// Reflection Archive: the persistent, cross-session "personal knowledge
// vault". Reads from localStorage whenever opened, fully searchable.
// Available both from the importer screen and from inside a reading
// session, since it's independent of any single article.
    ...
    <>
      ...
      >
        ...
        <input
          ...
          aria-label="Search all historical reflections"
